export class InputHandler {
    ...
    clampCamera() {
        ...
        this.camera.y = Math.max(this.bounds.minY - marginY, Math.min(this.camera.y, this.bounds.maxY + marginY));
    }
    onPointerDown(e) {
        ...
        if (this.evCache.length === 1) {
            ...
            this.prevDiff = Math.hypot(this.evCache[0].clientX - this.evCache[1].clientX, this.evCache[0].clientY - this.evCache[1].clientY);
        }
    }
    onPointerMove(e) {
        ...
        if (this.evCache.length === 2) {
            // Pinch-to-zoom
            const curDiff = Math.hypot(this.evCache[0].clientX - this.evCache[1].clientX, this.evCache[0].clientY - this.evCache[1].clientY);
            if (this.prevDiff > 0) {
